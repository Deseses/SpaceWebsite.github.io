 ...
 */ function createComets() {
    const cometCount = 6;
    comets = [];
    for(let i = 0; i < cometCount; i++)comets.push({
        x: Math.random() * canvas.width,
        y: Math.random() * canvas.height,
 ...
 */ function createAsteroids() {
    ...
    asteroids = [];
    for(let i = 0; i < asteroidCount; i++)asteroids.push({
        x: Math.random() * canvas.width,
        y: Math.random() * canvas.height,
 ...
 */ function drawStars(time) {
    ...
    comets.forEach((comet)=>{
        ...
        ctx.lineTo(comet.x - comet.speedX * comet.tailLength, comet.y - comet.speedY * comet.tailLength);
 ...
 */ function animate(time) {
    ...
    if (telescope.style.display === 'block') updateTelescope();
}
/**
 ...
 */ function updateTelescope() {
    ...
    viewCtx.drawImage(canvas, zoomX, zoomY, zoomAreaSize, zoomAreaSize, 0, 0, telescopeSize, telescopeSize);
    const gradient = viewCtx.createRadialGradient(telescopeSize / 2, telescopeSize / 2, 0, telescopeSize / 2, telescopeSize / 2, telescopeSize / 2);
...
//# sourceMappingURL=asteroid.82c70236.js.map
