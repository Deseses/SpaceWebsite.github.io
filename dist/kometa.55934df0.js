...
})({"4cUcT":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "e3a1f32f55934df0";
"use strict";
...
},{}],"t3GCp":[function(require,module,exports,__globalThis) {
 ...
 */ class GLTFMaterialsEmissiveStrengthExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.emissiveStrength !== undefined) materialParams.emissiveIntensity = extension.emissiveStrength;
 ...
 */ class GLTFMaterialsClearcoatExtension {
    ...
    getMaterialType(materialIndex) {
        const extension = getMaterialExtension(this.parser, materialIndex, this.name);
        return extension !== null ? (0, _three.MeshPhysicalMaterial) : null;
    }
    extendMaterialParams(materialIndex, materialParams) {
        const extension = getMaterialExtension(this.parser, materialIndex, this.name);
        if (extension === null) return Promise.resolve();
        ...
        if (extension.clearcoatTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'clearcoatMap', extension.clearcoatTexture));
        if (extension.clearcoatRoughnessFactor !== undefined) materialParams.clearcoatRoughness = extension.clearcoatRoughnessFactor;
        if (extension.clearcoatRoughnessTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'clearcoatRoughnessMap', extension.clearcoatRoughnessTexture));
 ...
 */ class GLTFMaterialsIridescenceExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.iridescenceTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'iridescenceMap', extension.iridescenceTexture));
        ...
        if (extension.iridescenceThicknessTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'iridescenceThicknessMap', extension.iridescenceThicknessTexture));
        return Promise.all(pending);
    }
}
/**
 ...
 */ class GLTFMaterialsSheenExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.sheenColorTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'sheenColorMap', extension.sheenColorTexture, (0, _three.SRGBColorSpace)));
        if (extension.sheenRoughnessTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'sheenRoughnessMap', extension.sheenRoughnessTexture));
        return Promise.all(pending);
    }
}
/**
 ...
 */ class GLTFMaterialsTransmissionExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.transmissionTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'transmissionMap', extension.transmissionTexture));
        return Promise.all(pending);
    }
}
/**
 ...
 */ class GLTFMaterialsVolumeExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.thicknessTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'thicknessMap', extension.thicknessTexture));
 ...
 */ class GLTFMaterialsSpecularExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.specularTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'specularIntensityMap', extension.specularTexture));
        ...
        if (extension.specularColorTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'specularColorMap', extension.specularColorTexture, (0, _three.SRGBColorSpace)));
        return Promise.all(pending);
    }
}
/**
 ...
 */ class GLTFMaterialsBumpExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.bumpTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'bumpMap', extension.bumpTexture));
        return Promise.all(pending);
    }
}
/**
 ...
 */ class GLTFMaterialsAnisotropyExtension {
    ...
    extendMaterialParams(materialIndex, materialParams) {
        ...
        if (extension.anisotropyTexture !== undefined) pending.push(this.parser.assignTexture(materialParams, 'anisotropyMap', extension.anisotropyTexture));
        return Promise.all(pending);
    }
}
/**
...
/* GLTF PARSER */ class GLTFParser {
    ...
    loadTextureImage(textureIndex, sourceIndex, loader) {
        ...
        const promise = this.loadImageSource(sourceIndex, loader).then(function(texture) {
            ...
            texture.generateMipmaps = !texture.isCompressedTexture && texture.minFilter !== (0, _three.NearestFilter) && texture.minFilter !== (0, _three.LinearFilter);
	 ...
	 */ loadAnimation(animationIndex) {
        ...
        return Promise.all([
            ...
            const animation = new (0, _three.AnimationClip)(animationName, undefined, tracks);
	 ...
	 */ loadNode(nodeIndex) {
        ...
        return Promise.all([
            ...
            if (node.userData.pivot !== undefined && children.length > 0) {
                ...
                node.pivot = new (0, _three.Vector3)().fromArray(pivot);
	 ...
	 */ loadScene(sceneIndex) {
        ...
        return Promise.all(pending).then(function(nodes) {
            for(let i = 0, il = nodes.length; i < il; i++){
                ...
                if (node.parent !== null) scene.add((0, _skeletonUtilsJs.clone)(node));
                else scene.add(node);
            }
...
},{"three":"dsoTF","../utils/BufferGeometryUtils.js":"lUbxS","../utils/SkeletonUtils.js":"dDZi6","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lUbxS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"three":"dsoTF","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dDZi6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 ...
 */ function retarget(target, source, options = {}) {
    const quat = new (0, _three.Quaternion)(), scale = new (0, _three.Vector3)(), relativeMatrix = new (0, _three.Matrix4)(), globalMatrix = new (0, _three.Matrix4)();
    options.preserveBoneMatrix = options.preserveBoneMatrix !== undefined ? options.preserveBoneMatrix : true;
    options.preserveBonePositions = options.preserveBonePositions !== undefined ? options.preserveBonePositions : true;
    options.useTargetMatrix = options.useTargetMatrix !== undefined ? options.useTargetMatrix : false;
    options.hip = options.hip !== undefined ? options.hip : 'hip';
    options.hipInfluence = options.hipInfluence !== undefined ? options.hipInfluence : new (0, _three.Vector3)(1, 1, 1);
    ...
    if (options.preserveBoneMatrix) // restore matrix
 ...
 */ function retargetClip(target, source, clip, options = {}) {
    ...
    const numFrames = Math.round(clip.duration * (options.fps / 1000) * 1000), delta = clip.duration / (numFrames - 1), convertedTracks = [], mixer = new (0, _three.AnimationMixer)(source), bones = getBones(target.skeleton), boneDatas = [];
    ...
    for(let frame = 0; frame < end; ++frame){
        ...
        if (frame === end - 2) // last mixer update before final loop iteration
...
},{"three":"dsoTF","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["4cUcT"], null, "parcelRequireae6e", {})

//# sourceMappingURL=kometa.55934df0.js.map
